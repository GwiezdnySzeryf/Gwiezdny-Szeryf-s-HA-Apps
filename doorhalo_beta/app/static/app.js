const translations = {
  pl: {
    ...
    "settings.talkTargetHint": "Dla Reolinka użyj strumienia go2rtc, np. go2rtc://domofon. Strumień musi mieć backchannel do kamery.",
    ...
    "talk.statusReolinkReady": "Adapter Reolink gotowy: audio trafi do go2rtc",
  ...
  en: {
    ...
    "settings.talkTargetHint": "For Reolink, use a go2rtc stream, for example go2rtc://doorbell. The stream must have a camera backchannel.",
    ...
    "talk.statusReolinkReady": "Reolink adapter ready: audio will be sent to go2rtc",
