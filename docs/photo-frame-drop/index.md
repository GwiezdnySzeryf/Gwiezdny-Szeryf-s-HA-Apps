...
**Photo Frame Drop** to dodatek do Home Assistanta, który dostarcza chroniony hasłem interfejs webowy do błyskawicznego przesyłania zdjęć z telefonu lub komputera bezpośrednio na dysk HA — gotowy do podłączenia z cyfrową ramką.
...
| 🔒 Ochrona hasłem | Sesje na bazie SHA-256, blokada brute-force |
...
1. [Zainstaluj dodatek](installation.md) przez HACS lub ręcznie
